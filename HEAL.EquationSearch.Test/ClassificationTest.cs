...
namespace HEAL.EquationSearch.Test {
  ...
  public class ClassificationTest {
    ...
    [DataTestMethod]
    [DataRow(20)]
    public void BankruptcyBreadthFirstSearchReducedGrammar(int maxLength) {
      ...
      GetBankruptcyData(options, out var inputs, out var trainX, out var trainY);
    ...
    public void BikesharingBreadthFirstSearchReducedGrammar(int maxLength) {
      ...
      var alg = new Algorithm();
      var likelihood = new SimpleGaussianLikelihood(trainX, trainY, modelExpr: null);
      // var evaluator = new Evaluator(likelihood);
    ...
    private static void GetBankruptcyData(Console.Program.RunOptions options, out string[] inputs, out double[,] trainX, out double[] trainY) {
